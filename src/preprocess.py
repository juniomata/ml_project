...
def ohe_transform(set_data: pd.DataFrame, transformed_column: str, ohe_cat: OneHotEncoder) -> pd.DataFrame:
    # Create copy of set data
    set_data = set_data.copy()
    # Load ohe customer_statuscal var --del
    # ohe_cat = util.pickle_load(ohe_path) --del
